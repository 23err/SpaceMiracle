...
class AnimationObjectActivity : AppCompatActivity() {
    ...
    companion object {
        private const val TAG = "AnimationObjectActivity"
    }
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_two_container.setOnClickListener {
                        Toast.makeText(this@AnimationObjectActivity, "Option 2", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_one_container.setOnClickListener {
                        Toast.makeText(this@AnimationObjectActivity, "Option 1", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
        ...
        transparent_background.animate()
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    transparent_background.setOnClickListener {
                        collapseFAB()
                    }
                }
            })
